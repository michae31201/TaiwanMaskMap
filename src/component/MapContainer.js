...
class MapContainer extends React.Component{   
    ...
    render(){
        const {mapCenter, userCoords, zoom, stores, google, selectedPlaceName, showingInfoWindow, closeStoreInfo} = this.props;
        ...
        return(
            ...
            >   
            <div style={{position:"absolute",right:"4rem",top:".7rem",zIndex:"5",backgroundColor:"#FFFFFF",padding:".5rem",borderRadius:"5px",fontWeight:"600"}}>
